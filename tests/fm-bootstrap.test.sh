...
gateway with an Anthropic model is flagged^{"default":{"harness":"claude","model":"claude-sonnet-5","provider":"codex","gateway":"cliproxy"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - gateway cliproxy profile needs a model that is not an Anthropic model (a claude prefix or one of Claude Code's own aliases): Anthropic models never go through the proxy
gateway with a Claude Code alias model is flagged^{"default":{"harness":"claude","model":"opus","provider":"codex","gateway":"cliproxy"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - gateway cliproxy profile needs a model that is not an Anthropic model (a claude prefix or one of Claude Code's own aliases): Anthropic models never go through the proxy
gateway with an upper-case Anthropic model is flagged^{"default":{"harness":"claude","model":"CLAUDE-sonnet-5","provider":"codex","gateway":"cliproxy"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - gateway cliproxy profile needs a model that is not an Anthropic model (a claude prefix or one of Claude Code's own aliases): Anthropic models never go through the proxy
gateway without a model is flagged^{"default":{"harness":"claude","provider":"codex","gateway":"cliproxy"}}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - gateway cliproxy profile needs a model that is not an Anthropic model (a claude prefix or one of Claude Code's own aliases): Anthropic models never go through the proxy
